...
import { loginWithEmail, signInWithGoogle, GOOGLE_ANDROID_CLIENT_ID, GOOGLE_WEB_CLIENT_ID } from '../../services/auth';
 ...
 * Remplaçable plus tard par un vrai asset image.
 */
function AppIcon() {
  return (
    ...
    >
      ...
      >
        ...
        <View style={[styles.card, { backgroundColor: cardColor }]}>
          <Text style={[styles.screenTitle, { color: textColor }]}>{t('auth.loginTitle')}</Text>
          ...
          >
            ...
            <Text style={[styles.googleButtonText, { color: textColor }]}>{t('auth.googleBtn')}</Text>
          </TouchableOpacity>
        </View>
